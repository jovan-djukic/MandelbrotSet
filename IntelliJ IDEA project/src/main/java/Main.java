...
public class Main implements GLEventListener, MouseListener {
	...
	private void checkForError ( GL4 gl ) {
	...
	public void display(GLAutoDrawable glAutoDrawable) {
		...
		int maxIterationPosition = this.shaderProgram.getUniformLocation(MandelbrotShaderProgram.Uniforms.maxIteration);
		int maxValuePosition = this.shaderProgram.getUniformLocation(MandelbrotShaderProgram.Uniforms.maxValue);
		int transformPosition = this.shaderProgram.getUniformLocation(MandelbrotShaderProgram.Uniforms.transform);
